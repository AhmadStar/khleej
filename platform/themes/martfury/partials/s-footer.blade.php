 <footer class="ps-footer">
            ...
            <div class="ps-footer__widgets">
                @if (theme_option('hotline') || theme_option('address') || theme_option('email') || theme_option('social-name-1'))
                    <aside class="widget widget_footer widget_contact-us">
                        <p class="widget-title">{{ __('Contact us') }}</p>
                        <div class="widget_content hotline">
                            @if (theme_option('hotline'))
                                <p>{{ __('Call us 24/7') }}</p>
                                <h3>{{ theme_option('hotline') }}<br>905524453317</h3>
                            @endif
    ...
    {!! Theme::footer() !!}
 <script src="https://cdn.jsdelivr.net/npm/hijri-date@1.1.4/dist/hijri-date.js"></script>

 <script src="/themes/martfury/js/vue.js?v=1.23.4"></script>
 <script src="/themes/martfury/js/services-vue.js?v=1.23.4"></script>
